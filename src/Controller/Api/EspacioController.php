...
class EspacioController extends AbstractController
{
    ...
    public function index(Request $request, EspacioRepository $espacioRepository, PaginatorInterface $paginator): Response
    {
        ...
        $listadoEspacios = $paginator->paginate($query, $currentPage, 10);
        $resultado = [];
        foreach ($listadoEspacios as $espacio) {
            $resultado[] = [
                'id' => $espacio->getId(),
    ...
    public function new(Request $request, EntityManagerInterface $em): Response
    {
        ...
        if (isset($data['nombre'])) {
            ...
            return new Response('Campo nombre no encontrado', 401);
        }
